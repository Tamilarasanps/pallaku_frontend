  ...
  return (
    <footer className="bg-gray-900 text-white px-4 py-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Brand Info */}
        <div>
          <h2 className="text-lg font-semibold mb-4">MachineStreets</h2>
          <p className="text-sm text-gray-300">
            Your one-stop shop for industrial tools and machinery. Trusted by professionals across India.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mb-2">Email: support@machinestreets.com</p>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-sm text-center text-gray-400">
        © {new Date().getFullYear()} Pallaku. All rights reserved. | Developed by <span className="text-orange-500 font-semibold">Rt-info tech</span>
      </div>
    </footer>
  );
};
