      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center px-6 gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            With our <strong>trusted vehicles</strong> and <strong>expert drivers</strong>, we ensure a safe and comfortable experience for every traveler.  
            Whether it's a family trip, business travel, or adventure tour, we've got you covered.
          </p>
          <p className="mt-4 text-gray-600">
            We offer a variety of <strong>vehicle options</strong> at competitive rates, ensuring the best travel experience across Tamil Nadu and beyond.
          </p>
